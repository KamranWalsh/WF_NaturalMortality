...
origpar <- par(no.readonly = TRUE)
par(mfrow=c(1, 2), mar=c(3, 1, 3, 0.5), oma=c(4, 4, 2, 1))
...
bubble.legend1 <- c(0.05,0.2,0.4)
bubble.legend2 <- bubble.legend1 * scale.catch.obs
legend("topright", xpd=TRUE, legend=bubble.legend1, pch=rep(21, 3), pt.cex=bubble.legend2, horiz=T , col='black', bty="n", inset=c(0, -0.06))
